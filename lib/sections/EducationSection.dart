  ...
  Widget build(BuildContext context) {
    return Column(
      children: educations.map((edu) => 
        buildEducationItem(edu.position, edu.university, edu.year, edu.details)
      ).toList(),
    );
  }

  Widget buildEducationItem(String degree, String university, String year, String details){
    return Card(
      elevation: 2,
